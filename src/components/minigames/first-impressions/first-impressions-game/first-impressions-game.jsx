  ...
  const getQuestions = () => {
    let qs = {
      questions: [
        ...
        {
          imageUrl:
            "https://ichef.bbci.co.uk/news/976/cpsprodpb/73C2/production/_122743692_4e7c0805-6e29-4caf-af85-e4e451db69af.png",
          option1: "Options 2",
          option2: "Options 3",
          option3: "Options 4",
          option4: "Options 1",
        ...
        {
          imageUrl:
            "https://cdn.mos.cms.futurecdn.net/XR4xMcbi2Bv65Fuf2fMAJX.jpeg",
          option1: "Options 4",
          option2: "Options 3",
          option3: "Options 2",
          option4: "Options 1",
        ...
        {
          imageUrl:
            "https://variety.com/wp-content/uploads/2019/09/peaky-blinders-season-5.jpg?w=681&h=383&crop=1",
          option1: "Options 2",
          option2: "Options 3",
          option3: "Options 1",
          option4: "Options 4",
    ...
    >
      <div className={"first-impressions-game-cards"}>
        ...
        <div className={"first-impressions-card-main"}>
          <LoadingBar
            width={
              ((TIME_PER_QUESTION - timeRef.current) / TIME_PER_QUESTION) * 100
            }
          />
          ...
          <div className={"first-impressions-infobox"}>
            <div className={"infobox-left"}>
              <div className={"inline-objects"}>
                ...
                />
                <p>
                  Time remaining: <b>{timeRef.current}</b>
                </p>
              </div>
              <div className={"inline-objects"}>
                <img
